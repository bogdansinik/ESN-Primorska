(function (e) {
    var t = !1, i = !1, o = {
        isUrl: function (e) {
            ...
            if ("open" === o || "toogle" === o && !c.is(":visible")) {
                ...
                t = !0, "right" === v ? (a = {right: p + "px"}, d = {right: "0px"}) : (a = {right: p + "px"}, d = {right: "0px"}), l = u.scrollTop(), u.css("overflow-x", "hidden").scrollTop(l), f.css({
                    width: f.width(),
                    position: "absolute"
                ...
                if (!c.is(":visible") || t) return;
                t = !0, "right" === v ? (a = {right: 0}, d = {right: "-" + p + "px"}) : (a = {right: 0}, d = {right: "-" + p + "px"}), l = u.scrollTop(), u.removeAttr("style").scrollTop(l), f.animate(a, y), c.animate(d, y, function () {
    ...
    e.sidr = function (t) {
        ...
        var i = e.extend({name: "sidr", speed: 200, side: "right", source: null, renaming: !0, body: "body"}, t),
            n = i.name, s = e("#" + n);
